...
xychart-beta
    ...
    x-axis "Algorithm" ["RNG","REG", "GNG", "GEG", "RNS","RES", "GNS", "GES"]
    y-axis "Score" 65000 --> 85000
    bar [82039, 82039, 70602, 70004, 81178, 72938, 71041, 70397]
```
...
---
xychart-beta
    title "Time executions"
    x-axis "Algorithm" ["RNG","REG", "GNG", "GEG", "RNS","RES", "GNS", "GES"]
    y-axis "Time" 5000 --> 30000
    bar [7634, 5436, 13122, 13836, 27127, 18214, 12350, 12498]
```
...
xychart-beta
    title "Minimal scores"
    x-axis "Algorithm" ["RNG","REG", "GNG", "GEG", "RNS","RES", "GNS", "GES"]
    y-axis "Score" 40000 --> 60000
    bar [53396, 45665, 43826, 43790, 56112, 46957, 43862, 43958]
```
...
xychart-beta
    ...
    x-axis "Algorithm" ["RNG","REG", "GNG", "GEG", "RNS","RES", "GNS", "GES"]
    y-axis "Time" 5000 --> 30000
    bar [7254, 5166, 12566, 12623, 28967, 18860, 12597, 12690]
```
